Analysis of onlines sales data from a 2021 retailer dataset obtained from Kaggle. Primarily uses pandas to organize and matplotlib to display the data. Uses sklearn for regression analysis.
