...
def render_dashboard(
    ...
    body = f"""
      ...
      <main>
        ...
        <section>
          <div class="section-heading"><div><p class="eyebrow">EXPLORE</p><h2>News worth opening</h2></div><p class="link-hint">Underlined headlines open the original story <span aria-hidden="true">↗</span></p></div>
...
@media(max-width:650px){.hero{padding-top:38px}.hero-meta{align-items:flex-start}.archive-picker span{display:none}.archive-picker select{padding:4px 23px 4px 7px;font-size:.72rem}.signal{padding:25px}.section-heading{display:block}.link-hint{max-width:none;text-align:left;margin-top:8px}.story{padding:15px}}
"""
