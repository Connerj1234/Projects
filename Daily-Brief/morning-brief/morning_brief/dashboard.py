...
def render_dashboard(
    ...
    display_date = compact_date(date)
    ...
    body = f"""
      <header class="hero">
        <div class="hero-meta">
          <p class="eyebrow">YOUR DAILY BRIEF · {escape(display_date)}</p>
